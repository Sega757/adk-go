...
var (
	...
	ErrNilDecisionPacket    = errors.New("decision packet cannot be nil")
	ErrInvalidConfidence    = errors.New("confidence score must be a valid float between 0.0 and 1.0")
	ErrInvalidVulnerability = errors.New("vulnerability score must be a valid float between 0.0 and 1.0")
)
