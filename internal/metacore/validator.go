...
var (
	...
	ErrNilPacket            = errors.New("DecisionPacket (R) cannot be nil")
	ErrInvalidConfidence    = errors.New("Confidence score must be a number between 0.0 and 1.0")
	ErrInvalidVulnerability = errors.New("Vulnerability score must be a number between 0.0 and 1.0")
)
